...
/**
 * printf_magic - Prints the magic numbers of an ELF header.
 * @e_ident: A pointer to an array containing the ELF magic numbers.
 *Return: none
 */
...
/**
 * printf_abi -outputs the ABI version of an ELF header.
...
/**
 * printf_input - Prints the entry point of an ELF header file
...
/**
 * end_elf - exits  ELF file
 * @elf: descriptor of an ELF
 * Return: 0 on success
 */
